...
**Data Structure & Algorithm** — เนื้อหาภาษาไทย ครอบคลุม **69 หัวข้อ** ตั้งแต่พื้นฐานจนถึงระดับเตรียมสัมภาษณ์

## ✨ จุดเด่น

- **69 หัวข้อ** จำลองการทำงานทีละขั้นตอน (เล่น / หยุด / เดิน / ถอย / ปรับความเร็ว / ใส่ข้อมูลเอง)
...
| 3 · กราฟ | การแทนกราฟ, BFS/DFS, Dijkstra, Bellman-Ford, Floyd-Warshall, MST (Kruskal/Prim), Union-Find, Topological Sort |
| 4 · เรียงลำดับ | Bubble, Selection, Insertion, Merge, Quick, Heap, Counting, Radix |
| 5 · ค้นหา | Linear, Binary, Jump, Interpolation, Exponential, Ternary, A* (pathfinding), Minimax/Alpha-Beta, Two Pointers, Sliding Window |
| 6 · ออกแบบอัลกอริทึม | Divide & Conquer, Greedy, DP (LCS/Knapsack/Coin Change/Edit Distance/LIS), Backtracking (N-Queens/Sudoku/Maze/Permutations), Kadane, Huffman |
| 7 · ขั้นสูง | KMP, Rabin-Karp, P/NP, Bit Manipulation, Sieve of Eratosthenes, Convex Hull |
