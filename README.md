...
**Data Structure & Algorithm** — เนื้อหาภาษาไทย ครอบคลุม **65 หัวข้อ** ตั้งแต่พื้นฐานจนถึงระดับเตรียมสัมภาษณ์

## ✨ จุดเด่น

- **65 หัวข้อ** จำลองการทำงานทีละขั้นตอน (เล่น / หยุด / เดิน / ถอย / ปรับความเร็ว / ใส่ข้อมูลเอง)
...
| 5 · ค้นหา | Linear, Binary, Jump, Interpolation, Two Pointers, Sliding Window |
