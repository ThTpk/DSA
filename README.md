...
**Data Structure & Algorithm** — เนื้อหาภาษาไทย ครอบคลุม **96 หัวข้อ** ตั้งแต่พื้นฐานจนถึงระดับเตรียมสัมภาษณ์

## ✨ จุดเด่น

- **96 หัวข้อ** จำลองการทำงานทีละขั้นตอน (เล่น / หยุด / เดิน / ถอย / ปรับความเร็ว / ใส่ข้อมูลเอง)
...
| 2 · ต้นไม้ | Binary Tree, BST, AVL, Red-Black, Heap, Trie, Segment Tree, Fenwick (BIT), Priority Queue, B-Tree, B+ Tree, Fibonacci Heap, van Emde Boas |
| 3 · กราฟ | การแทนกราฟ, BFS/DFS, Dijkstra, Bellman-Ford, Floyd-Warshall, MST (Kruskal/Prim), Union-Find, Topological Sort, SCC (Kosaraju), Articulation/Bridges, Max Flow (Edmonds-Karp), Bipartite Matching, Johnson's (all-pairs) |
| 4 · เรียงลำดับ | Bubble, Selection, Insertion, Merge, Quick, Heap, Counting, Radix, Bucket |
| 5 · ค้นหา | Linear, Binary, Jump, Interpolation, Exponential, Ternary, A* (pathfinding), Minimax/Alpha-Beta, Quickselect, Median of Medians, Two Pointers, Sliding Window |
...
| 7 · ขั้นสูง | KMP, Rabin-Karp, Z-algorithm, Boyer-Moore, P/NP, Bit Manipulation, Sieve, Euclid GCD, Modular Exponentiation, Miller-Rabin, Closest Pair, Strassen, Suffix Array, Vertex Cover (approx), Simplex/LP, FFT, Convex Hull |
